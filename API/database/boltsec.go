...
// On garde, on le fera bouger avec une gestion des flags
var Debug = false
...
// GetDB allow to retrieve the original boltDB object
func (dbm *DBManager) GetDB() *BoltsecDB {
	return dbm.db
}
